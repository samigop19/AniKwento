...
<body>
                    ...
                    <div class="profile-main-info">
                        <div class="profile-picture-section">
                            <div class="profile-picture-wrapper">
                                <img src="<?= $teacher['photo'] ? safe('../../uploads/' . $teacher['photo']) : 'images/teacher-placeholder.png' ?>" alt="Teacher Profile" class="profile-picture" id="profilePicture">
                        ...
                        <div class="edit-section">
                            ...
                            <div class="picture-edit-section">
                                <div class="current-picture">
                                    <img src="<?= $teacher['photo'] ? safe('../../uploads/' . $teacher['photo']) : 'images/teacher-placeholder.png' ?>" id="editProfilePicture" class="edit-profile-img" alt="Profile">
                                </div>
    ...
    async function saveProfileToServer() {
        ...
        // NOTE: file sits in api/save_profile.php (relative path from this file)
        const endpoint = '../../handlers/save_profile.php';
