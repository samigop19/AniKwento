...
<head>
  ...
  <link id="theme-style" rel="stylesheet" href="../../../public/files/css/SettingsDashboard.css?v=1.0">
</head>
<body>
      ...
      <div class="header-content">
        ...
        <nav>
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a href="/source/pages/dashboard/SettingsDashboard.php" class="nav-link active">
